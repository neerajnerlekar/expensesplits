    ...
    <div className="flex items-center space-y-4 flex-col flex-grow pt-10">
      <div className="px-5 mb-8 flex flex-col items-center max-w-5xl space-y-4">
        ...
        <p className="my-0 text-center max-w-2xl">
          Split expenses with friends across any chain. Track in stable USD value with PYUSD, settle with any token via
          Yellow Network or PayPal bridge.
        </p>
      </div>
          ...
          <div className="card bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-xl">
            <div className="card-body">
              ...
              <p className="text-white/90">
                BatchPay supports PayPal USD (PYUSD) for stable expense tracking and cross-chain settlements. Use PayPal
                bridge for instant Ethereum ↔ Solana transfers.
              </p>
